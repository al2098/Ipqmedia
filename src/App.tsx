...
function PageContent() {
  ...
  return (
    <div className={cn("min-h-screen font-sans", theme === 'trace' && "bg-white/90 backdrop-blur-sm")}>
      {/* Scroll Progress Bar */}
      <motion.div
      ...
      <nav className="fixed top-0 w-full z-50 border-b border-white/10 bg-[#0A0A0A]/80 backdrop-blur-md flex items-center justify-between px-10 h-16 transition-colors duration-500">
        <div className="flex items-center gap-8">
          ...
          <div className="hidden md:flex gap-6 text-[10px] uppercase tracking-widest text-[#E0E0E0]">
